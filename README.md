# go-optikon [![GoDoc][godoc image]][godoc] [![Build Status][travis image]][travis] [![Coverage Status][coveralls image]][coveralls] [![sourcegraph views][sourcegraph image]][sourcegraph]
